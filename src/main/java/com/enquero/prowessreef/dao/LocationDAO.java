...
import com.enquero.prowessreef.model.Location;
...
public class LocationDAO implements ILocationDAO {
	...
	public void save(Location entity) {
		EntityManagerHelper.log("saving Location instance", Level.INFO, null);
		try {
	...
	public void delete(Location entity) {
		EntityManagerHelper.log("deleting Location instance", Level.INFO, null);
		try {
			entity = getEntityManager().getReference(Location.class, entity.getLocationId());
	 ...
	 * <pre>
	 * EntityManagerHelper.beginTransaction();
	 * entity = LocationDAO.update(entity);
	 * EntityManagerHelper.commit();
	 * </pre>
	 * 
	...
	public Location update(Location entity) {
		EntityManagerHelper.log("updating Location instance", Level.INFO, null);
		try {
			Location result = getEntityManager().merge(entity);
	...
	public Location findById(Integer id) {
		EntityManagerHelper.log("finding Location instance with id: " + id, Level.INFO, null);
		try {
			Location instance = getEntityManager().find(Location.class, id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Location> findByProperty(String propertyName, final Object value, final int... rowStartIdxAndCount) {
		EntityManagerHelper.log("finding Location instance with property: " + propertyName + ", value: " + value,
				Level.INFO, null);
		try {
	...
	public List<Location> findAll(final int... rowStartIdxAndCount) {
		EntityManagerHelper.log("finding all Location instances", Level.INFO, null);
		try {
